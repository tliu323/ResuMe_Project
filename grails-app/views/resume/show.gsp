...
<html>
    ...
    <body>
        ...
        <div id="show-resume" class="content scaffold-show" role="main">
            ...
            <f:display bean="resume" />
            <g:form resource="${this.resume}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resume}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
