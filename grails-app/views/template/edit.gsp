...
<html>
    ...
    <body>
        ...
        <div id="edit-template" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.template}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.template}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.template}" method="PUT">
                <g:hiddenField name="version" value="${this.template?.version}" />
                <fieldset class="form">
                    <f:all bean="template"/>
                </fieldset>
